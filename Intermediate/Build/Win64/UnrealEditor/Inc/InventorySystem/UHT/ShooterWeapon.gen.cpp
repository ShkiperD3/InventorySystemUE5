...
INVENTORYSYSTEM_API UClass* Z_Construct_UClass_AShooterProjectile_NoRegister();
INVENTORYSYSTEM_API UClass* Z_Construct_UClass_AShooterWeapon();
INVENTORYSYSTEM_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
...
struct Z_Construct_UClass_AShooterWeapon_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponID_MetaData[] = {
		{ "Category", "ShooterWeapon" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// UI display name. Decouples gameplay class name from player-facing text\n" },
#endif
		{ "ModuleRelativePath", "Variant_Shooter/Weapons/ShooterWeapon.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "UI display name. Decouples gameplay class name from player-facing text" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponIcon_MetaData[] = {
		{ "Category", "ShooterWeapon" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//UI display icon\n" },
#endif
		{ "ModuleRelativePath", "Variant_Shooter/Weapons/ShooterWeapon.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "UI display icon" },
#endif
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponID = { "WeaponID", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AShooterWeapon, WeaponID), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponID_MetaData), NewProp_WeaponID_MetaData) };
const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponName = { "WeaponName", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AShooterWeapon, WeaponName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponName_MetaData), NewProp_WeaponName_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponIcon = { "WeaponIcon", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AShooterWeapon, WeaponIcon), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponIcon_MetaData), NewProp_WeaponIcon_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AShooterWeapon_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponID,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AShooterWeapon_Statics::NewProp_WeaponIcon,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_InventorySystem_Source_InventorySystem_Variant_Shooter_Weapons_ShooterWeapon_h__Script_InventorySystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterWeapon, AShooterWeapon::StaticClass, TEXT("AShooterWeapon"), &Z_Registration_Info_UClass_AShooterWeapon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterWeapon), 2813057173U) },
	};
}; // Z_CompiledInDeferFile_FID_InventorySystem_Source_InventorySystem_Variant_Shooter_Weapons_ShooterWeapon_h__Script_InventorySystem_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_InventorySystem_Source_InventorySystem_Variant_Shooter_Weapons_ShooterWeapon_h__Script_InventorySystem_466354647{
	TEXT("/Script/InventorySystem"),
	Z_CompiledInDeferFile_FID_InventorySystem_Source_InventorySystem_Variant_Shooter_Weapons_ShooterWeapon_h__Script_InventorySystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_InventorySystem_Source_InventorySystem_Variant_Shooter_Weapons_ShooterWeapon_h__Script_InventorySystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
